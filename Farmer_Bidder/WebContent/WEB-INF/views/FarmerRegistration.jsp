...
<form:form action="add" 
	...
	<c:if test="${!empty farmer.farmerName}"><br/>
	 ...
	 <div class="container">
      ...
      <h3>Personal information:</h3>
		 ...
		 <form:input path="farmerName" type="text"
	...
	<form:label path="address.state">
		 ...
		 <form:input path="landDetails.area"  class="form-control"
		  id="address" placeholder="Enter area in acer" name="area"
		  required=" "/>
          
          <form:label path="landDetails.landAddress">
          <spring:message text="Land Address"/>
          </form:label>
			<form:input path="landDetails.landAddress"  class="form-control" id="address" 
			placeholder="Enter area" name="area"  required=" " />
			
			<form:label path="landDetails.landPincode" type="number">
				<spring:message text="Pin code"/>
			</form:label>
		 <form:input path="landDetails.landPincode"  class="form-control" 
		 id="pincode" placeholder="Enter pincode" name="pincode"  required=" "/>
			</div>
 ...
 <div class="form-group">
		 ...
		 id="aadhar" placeholder="1234-1234-1234" name="aadhar"  />
